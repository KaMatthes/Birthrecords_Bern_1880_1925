...
Figure1 <- cowplot::plot_grid(p1,p2,p3,p4, nrow=2, ncol=2, labels = c("A","B","C","D"),
                              label_size = 14)
...
Supplement1 <- cowplot::plot_grid(density_plot_old, density_plot_new,ncol=1,nrow=2, labels=c("A", "B"),
                                  label_size = 20)

# cowplot::save_plot("output/Supplement1.pdf", Supplement1,base_height=15,base_width=15)
...
boxplot_agemenarche <- ggplot(data=data_plot)+
 ...
 Supplement2 <- cowplot::plot_grid(boxplot_weight,boxplot_Alter, 
                                   boxplot_GestationalAge,boxplot_agemenarche,
                                   ncol=2,nrow=2, align="hv", labels=c("A","B","C", "D"),
                                   label_size = 50)
 
 # cowplot::save_plot("output/Supplement2.pdf", Supplement2,base_height=50,base_width=55,limitsize = FALSE)
 
 Supplement3 <- cowplot::plot_grid(Boyplot,ParaKatplot, 
 ...
 # cowplot::save_plot("output/Supplement3.pdf", Supplement3 ,base_height=50,base_width=30,limitsize = FALSE)
 
 Supplement4 <- cowplot::plot_grid(  Birthmonth_catplot_total, barplot_Birthweekday_total, 
                                     Birthmonth_catplot, barplot_Birthweekday,
                                   ncol=2,nrow=2, align="hv", labels=c("A","B","C","D"),
                                   label_size = 50)
 # 
 # cowplot::save_plot("output/Supplement4.pdf",  Supplement4,base_height=50,base_width=55,limitsize = FALSE)
 
 Supplement5 <- cowplot::plot_grid(    matbodyplot, matheightplot,
