function_plot_timeseries_stillborn <- function(Timespan, Var) {
  ...
  if (Timespan =="weekly") {
   ...
   cowplot::save_plot("output/Supplement8.pdf", Supplement8 ,base_height=10,base_width=15)
...
function_plot_timeseries_stillborn(Timespan="weekly")
