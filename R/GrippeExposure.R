data.grippe.org <- read.csv(paste0("data_raw/",data.grippe), sep=";",header=TRUE)
...
save(datagrippe,file=paste0("data/datagrippe.RData"))
write.table(datagrippe,file=paste0("data/datagrippe.csv"),row.names=FALSE, sep=";")
