...
Gestational age, the differences are minimal (range: 39.6 - 40 weeks), there is no breakpoint.
```{r ,echo=FALSE, message=FALSE,warning=FALSE,fig.height = 10, fig.width = 10}
function_plot_timeseries(Timespan="weekly", Var="Gest")
function_plot_timeseries(Timespan="monthly", Var="Gest")
```

Stillborn = (sum of stillborn per week/sum birth per week) *100, no breakpoint, but more stillborns 1918/1919
```{r ,echo=FALSE, message=FALSE,warning=FALSE,fig.height = 10, fig.width = 10}
function_plot_timeseries_stillborn(Timespan="weekly")
function_plot_timeseries_stillborn(Timespan="monthly")
```
...
```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_boy_linear")
```

### Gestational age

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_gest_linear")
```

### Birth month

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_month_linear")
```

### Maternal age

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_matage_linear")
```

### Married

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_married_linear")
```

### City

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_city_linear")
```

### Insurance

```{r, echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5 ,fig.width = 5}
function_quantile_regression_1914_1922(varExp="unadjusted_insurance_linear")
```
...
### Flu Boxplot 
Data range from 09.07.1918 – 02.02.1919
<br />
Only multiple==0, matage > 50 and matage <14 were excluded
...
<!-- ### Flu intensity - 01.01.1914 - 31.01.1920` -->

<!-- ```{r, echo=FALSE, message=TRUE,warning=FALSE} -->
<!-- function_quantile_regression_1914_1922_flu(varExp="linear_Int") -->
<!-- ``` -->

### Flu intensity - Quantile Regression

```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 8, fig.width = 8}
function_quantile_regression_1914_1922(varExp="unadjusted_flu_qr")
```
<!-- GAM regression  -->
<!-- <br /> -->
<!-- <br /> -->
...
<!-- ```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5, fig.width = 8} -->
<!-- function_quantile_regression_1914_1922(varExp="unadjusted_gam_model_plot") -->
<!-- ``` -->
...
```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 8, fig.width = 8}
function_quantile_regression_1914_1922(varExp="adjusted_year_qr")
```

### Year

```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_quantile_regression_1914_1922(varExp="adjusted_year_linear")
```

```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_quantile_regression_1914_1922(varExp="adjusted_year_linear_plot")
```
<!-- Exposure sum -->
<!-- ```{r, echo=FALSE, message=TRUE,warning=FALSE} -->
...
<!-- ### Flu Intensity - 01.01.1914 - 31.01.1920 -->
<!-- ```{r, echo=FALSE, message=TRUE,warning=FALSE} -->
<!-- function_quantile_regression_1914_1922_flu(varExp="adjusted_year_linear_Int") -->
<!-- ``` -->

### Flu Intensity - Quantile Regression
```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 8, fig.width = 8}
function_quantile_regression_1914_1922(varExp="adjusted_flu_qr")
```
...
Flu
```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_regression_lbw(varExp= "unadjusted_Int")
```

```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_regression_lbw(varExp= "unadjusted_Int_plot")
```
...
Flu
```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_regression_lbw(varExp= "adjusted_Int")
```

```{r, echo=FALSE, message=TRUE,warning=FALSE}
function_regression_lbw(varExp= "adjusted_Int_plot")
```
...
<!-- ```{r, echo=FALSE, message=TRUE,warning=FALSE} -->
<!-- function_regression_gestage_flu(varExp="unadjusted_Int") -->
<!-- ``` -->

<!-- ```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5, fig.width = 5} -->
<!-- function_regression_gestage_flu(varExp="unadjusted_Int_plot") -->
<!-- ``` -->
...
<!-- ```{r, echo=FALSE,message=TRUE,warning=FALSE} -->
<!-- function_regression_gestage_flu(varExp="adjusted_Int") -->
<!-- ``` -->

<!-- ```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 8, fig.width = 5} -->
<!-- function_regression_gestage_flu(varExp="adjusted_Int_plot") -->
<!-- ``` -->
...
<!-- ```{r, echo=FALSE, message=TRUE,warning=FALSE} -->
<!-- function_regression_stillborn_flu(varExp="unadjusted_Int") -->
<!-- ``` -->

<!-- ```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 5, fig.width = 5} -->
<!-- function_regression_stillborn_flu(varExp="unadjusted_Int_plot") -->
<!-- ``` -->
...
<!-- ```{r, echo=FALSE,message=TRUE,warning=FALSE} -->
<!-- function_regression_stillborn_flu(varExp="adjusted_Int") -->
<!-- ``` -->

<!-- ```{r , echo=FALSE, message=FALSE,warning=FALSE,fig.height = 8, fig.width = 5} -->
<!-- function_regression_stillborn_flu(varExp="adjusted_Int_plot") -->
<!-- ``` -->